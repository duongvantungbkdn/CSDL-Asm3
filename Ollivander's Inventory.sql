...
Write a query to print the 
	...
	coins_needed, 
	and power 
of the wands that Ron's interested in, sorted in order of descending power. 
...
select W.ID, P.age, W.coins_needed, W.power
            ...
            where W.code = P.code and P.is_evil = 0
                -- choose min of coins_needed if has same power and age
                and W.coins_needed = (
                    select min(W1.coins_needed)
                    from Wands W1, Wands_Property P1
                    where W1.code = P1.code and W.power = W1.power and P.age = P1.age
                    )
